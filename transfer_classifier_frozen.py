...
if transfer == True:
    out_dir = out_dir + '_transfer_classifier'
...
with h5py.File('/ocean/projects/phy210068p/hsu1/Training_results/' + sim + '/frozen_layers_' + roc_title + '_roc_parameters.hdf5', 'a') as f:
        f.create_dataset('5D_ep_i_classifier_frozen', data=epsilon_i)
        f.create_dataset('5D_ep_a_classifier_frozen', data=epsilon_a)